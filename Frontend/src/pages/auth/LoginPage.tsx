        ...
        onSuccess: async (tokenResponse) => {
            try {
                ...
                if (response.twoFactorRequired) {
                    ...
                    setTwoFactorEmail(userInfo.email);
                                ...
                                <>
                                    <div className="mb-5">
                                        <button
                                            ...
                                            className="text-xs text-primary font-bold uppercase tracking-widest flex items-center gap-2 hover:opacity-80 transition-opacity mb-4"
                                        >
                                        ...
                                        <p className="text-sm text-on-surface-variant">
                                            Enter the 6-digit code sent to your email or use a backup code.
                                        </p>
                                    </div>
                                    ...
                                    <form className="space-y-6" onSubmit={handle2FASubmit}>
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                className="w-full bg-surface-container-low border-none focus:ring-1 focus:ring-primary/40 rounded-lg py-4 px-5 text-on-surface placeholder:text-slate-600 transition-all duration-300 text-center tracking-[0.2em] font-bold text-xl uppercase"
                                                id="twoFactorCode"
                                                placeholder="6-DIGIT OTP OR BACKUP CODE"
                                                type="text"
                                                value={twoFactorCode}
                                        ...
                                        <button
                                            className="w-full cursor-pointer primary-gradient text-on-primary py-4 rounded-full font-headline font-bold text-base hover:scale-[1.02] active:scale-95 transition-all duration-200 glow-shadow disabled:opacity-70"
                                            type="submit"
                                        ...
                                        <p className="text-xs text-center text-on-surface-variant leading-relaxed">
                                            Lost access to your email? Use one of your saved backup codes to log in.
                                        </p>
                                    </form>
                                </>
                            )}
